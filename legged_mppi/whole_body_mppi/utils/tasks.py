...
TASKS = {
    ...
    "stand_hw": {
        ...
        "waiting_times": [0],
        "model_path": DEFAULT_MODEL_PATH,
        "config_path": 'configs/mppi_gait_config_walk_hw.yml',
        "sim_path": DEFAULT_SIM_PATH
    },
    "push_box_hw": {
        "goal_pos": [[0, 0.0, 0.27], 
        ...
        "waiting_times": [None],
        "model_path": 'models/go1/go1_scene_mppi_pyr_push_box_14in.xml',
        "config_path": 'configs/mppi_gait_config_push_box_hw.yml',
        "sim_path": 'models/go1/go1_scene_mppi_pyr_push_box_14in.xml'
    },
    "walk_octagon_hw": {
        "goal_pos": [[0, 0, 0.27], 
    ...
    "climb_box_hw": {
        "goal_pos": [[-2.204, 0.03139, 0.27],
                     ...
                     [-0.304, 0.03139, 0.27]],
        "default_orientation": DEFAULT_ORIENTATION,
        "cmd_vel": [[0.0, 0.0]] + [[0.5, 0.0]] * 2 + [[0.0, 0.0]] + [[0.5, 0.0]] + [[0.0, 0.0]],
        "goal_thresh": [0.2] * 6,
        "desired_gait": ['in_place', 
                         'walk', 
                         'trot', 
        ...
        "waiting_times": [50,
                          ...
                          0, 
                          200],
        "model_path": 'models/go1/go1_scene_mppi_pyr_climb_box_hw.xml',
        "config_path": 'configs/mppi_gait_config_climb_box_hw.yml',
        "sim_path": 'models/go1/go1_scene_mppi_pyr_climb_box_hw.xml'
    },
}
